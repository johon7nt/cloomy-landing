  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0" aria-hidden>
      <div className="absolute inset-0">
        ...
        <div style={{ position:'absolute', bottom:'10%', left:'-6%', width:'36vw', height:'36vw', borderRadius:'50%', background:'radial-gradient(circle at 50% 50%, #9D7FFF 0%, #6C47FF 45%, transparent 72%)', filter:'blur(70px)', opacity:0.25 }} />
      </div>
