...
const NAV_LINKS = [
  ...
  },
  {
    ...
    submenu: [
      { label: 'Ver planes',      href: '#pricing',  icon: 'M4 6h16M4 10h16M4 14h8' },
      { label: 'Comparar planes', action: 'compare', icon: 'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2' },
    ],
  },
