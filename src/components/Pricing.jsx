      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-10 flex justify-center">
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium text-text-secondary hover:text-white transition-colors duration-200 group"
          >
            <svg className="w-4 h-4 text-brand-500 group-hover:text-brand-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
